...
def txt2img(prompt: str, ddim_steps: int, sampler_name: str, toggles: List[int], realesrgan_model_name: str,
    ...
    # prompt = opt.prompt;
    # print("TESTING:" + prompt + " " + str(ddim_steps) + " " + sampler_name + " " + str(toggles) + " " +  realesrgan_model_name + " " +
    #         str(ddim_eta) + " " +  str(n_iter) + " " +  str(batch_size) + " " + str(cfg_scale) + " " + str(seed) + " " + 
    #         str(height) + " " + str(width) + " " + str(variant_amount) + " " + str(variant_seed))
...
def generate():
    storyLines = []
    with open(opt.outdir+"/prompts.txt") as f:
